    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Display an error message to the user, indicating that they need to fill out all fields.
                if (playerName.isEmpty() || selectedRadioButtonId == -1) {
                    Toast.makeText(InitialConfigActivity.this, "Please fill out all fields", Toast.LENGTH_SHORT).show();
                } else {
